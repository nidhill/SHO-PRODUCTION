...
export default function Batches() {
  ...
  const openChangeSHO = async (batch: Batch) => {
    ...
    setSelectedSHOId((batch.assignedSHO as any)?._id || (batch.assignedSHO as any)?.id || '');
              ...
              {isLoadingSHOUsers ? (
                ...
                <div className="space-y-1.5 max-h-60 overflow-y-auto pr-0.5">
                  ...
                  {shoUsers.map(u => {
                    ...
                    const isCurrent = (changeSHOBatch?.assignedSHO as any)?._id === u._id || (changeSHOBatch?.assignedSHO as any)?.id === u._id;
                    return (
                      <button
                        key={u._id}
